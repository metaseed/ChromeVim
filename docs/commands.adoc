...
| showHintForOpenInInactiveTab
|       open link in new background tab


| showHintForOpenInActiveTab
|       open link in new tab and go to it (active)


| showHintForOpenInNewWindow
...
| showHintForMutipleImageSearch
|       reverse image search multiple links



| showHintForImageSearch
